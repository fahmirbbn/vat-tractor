                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="unit_code" value="{{ old('unit_code') }}" class="form-control" id="unit_code" placeholder="Unit Code">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="unit_name" class="col-sm-2 col-form-label">Unit Name</label>
                            <div class="col-sm-4">
                                <input type="text" name="unit_name" value="{{ old('unit_name') }}" class="form-control" id="unit_name" placeholder="Unit Name">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="pg_id" class="col-sm-2 col-form-label">Plantation Group</label>
                            <div class="col-sm-4">
                                <input type="text" name="pg_id" value="{{ old('pg_id') }}" class="form-control" id="pg_id" placeholder="Plantation Group">
                            </div>
                        </div>
                    </div>
