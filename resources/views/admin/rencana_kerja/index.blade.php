            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('admin.rencana_kerja.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Create</a>
                    </div>
                </div>
                <div class="card-body">
    ...
    <script>
        ...
        $(document).ready(function() {
            tabel = $('#tb_data').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.rencana_kerja.datatable') }}",
                columns: [
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            btn +=
                                `<div class="btn-group" role="group">
                                    <a class="btn btn-warning" href="{{ route('admin.rencana_kerja.index') }}/` + row.id + `/edit" title="Edit"><i class="fas fa-edit"></i></a>
                                    <form method="POST" name="delete-item" action="{{ route('admin.rencana_kerja.index') }}/` + row.id + `/destroy" class="d-inline">
                                        @csrf
                                        @method('DELETE')
