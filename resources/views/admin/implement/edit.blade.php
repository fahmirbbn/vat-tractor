...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content">
                <form action="{{ route('admin.implement.update', ['id' => $data->id]) }}" method="post">
                @csrf
                @method('PUT') 
                <div class="card">
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="implement_code" value="{{ old('implement_code', $data->implement_code) }}" class="form-control" id="implement_code" placeholder="Implement Code">
                            </div>
                        </div>
                        <div class="form-group row">
