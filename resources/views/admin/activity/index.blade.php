                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Master Activity</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('admin.activity.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Create</a>
                    </div>
                </div>
                <div class="card-body">
    ...
    <script>
        ...
        $(document).ready(function() {
            tabel = $('#tb_data').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.activity.datatable') }}",
                columns: [
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            btn +=
                                `<div class="btn-group" role="group">
                                    <a class="btn btn-warning" href="{{ route('admin.activity.index') }}/` + row.id + `/edit" title="Edit"><i class="fas fa-edit"></i></a>
                                    <form method="POST" name="delete-item" action="{{ route('admin.activity.index') }}/` + row.id + `/destroy" class="d-inline">
                                        @csrf
                                        @method('DELETE')
